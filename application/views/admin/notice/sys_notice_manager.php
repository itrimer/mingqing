...
<div id="page-wrapper">
	...
	<div id="main-wrapper">
		<div id="main-content">
	 		<div class="path">
	 			当前位置： <a href="../notice/">通知公告</a> > 系统通知
	 		</div>
			<div class="bar_block">
				<div class="float-left">
				<form name="formSearch" action="system_notice" method="get">
			   	标题：<input name="notice_title" type="text" class="width_100" value="<?php echo $notice_title?>" placeholder="标题">
			...
			<form action="">
				...
				<thead>
					<tr>
						<td width="25"><input type="checkbox" class="checkbox" value=""/></td>
						<td>通知名称</td>
...
$(function(){
	$('#notice_add').click(function(){
		...
		params.template_url = base_url_index + "admin/notice/sys_add";
	...
	$('#notice_edit').click(function(){
		...
		var params = {width:900, height:550};
		params.template_url = base_url_index + "admin/notice/sys_edit/" + ref,
		params.success_text = "保存成功";
		params.onsubmit=function(){$("textarea[name='content']").val(CKEDITOR.instances.content.getData());}
		do_template(params);
		return false;
	...
	$('#notice_delete').click(function(){
		...
		params.post_url = base_url_index + "admin/notice/sys_delete/" + ref,
